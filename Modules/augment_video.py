...
def flip_video(input_video_path, flip_code):
    """
    ...
    # List to store the flipped frames
    flipped_frames = []
    ...
    while True:
        ...
        # Append the flipped frame to the list
...
def random_resize_video(input_video_path, inter, width_range=(0.5, 2.0), height_range=(0.5, 2.0)):
    """
    ...
    # List to store the resized frames with black padding
    resized_frames = []
    ...
    while True:
        ...
        # Append the padded frame to the list
